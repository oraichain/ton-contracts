...
describe('Verify Tx', () => {
    ...
    let verify: SandboxContract<LightClient>;

    beforeEach(async () => {
        blockchain = await Blockchain.create();

        verify = blockchain.openContract(
        ...
        const deployResult = await verify.sendDeploy(deployer.getSender(), toNano('0.05'));
    ...
    it('test verify with 4 leaves', async () => {
        ...
        const result = await verify.getVerifyTx(decodedTxWithRawMsg, leaves, leaves[choosenIndex]);

        expect(result).toBe(-1);
    });

    xit('test verify with 1 leaves', async () => {
        const txs = [
            '',
        ];
        const leaves = txs.map((tx) => createHash('sha256').update(Buffer.from(tx, 'base64')).digest());
