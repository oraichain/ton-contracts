...
describe('LightClient', () => {
    ...
    it('test gen data_hash', async () => {
        ...
        const rootTxsHash = await lightClient.getHashTreeRoot(txs);
        console.log(rootTxsHash.toString(16));
        // expect(rootTxsHash.toString('hex')).toEqual('A64D5F48C307082069BB628CB2657977EEEC271671817BA489129B7983722951');
    });
